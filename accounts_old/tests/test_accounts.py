...
from accounts_old.services.token_service import account_activation_token
...
class CustomerSignUpViewTests(TestCase):
    ...
    @patch("account.services.email_service.EmailMessage.send")
    def test_user_created_as_inactive_and_email_sent(self, mock_send_email):
        ...
        self.assertTemplateUsed(response, "account/email_confirmation_sent.html")
